...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Team development for engineering organizations using collaborative scenario design and structured facilitation.",
  path: "/services/team-building",
  keywords: ["engineering team building", "technical team facilitation", "D&D team building"],
