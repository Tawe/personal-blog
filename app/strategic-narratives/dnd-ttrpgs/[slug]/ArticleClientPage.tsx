  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if (result === "shared" || result === "aborted") {
        setShareState("idle") // Reset state after successful/cancelled share dialog
      } else {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <div className="space-y-6">
            ...
            {/* External Links */}
            {(article.medium_link || article.devto_link || article.substack_link || article.linkedin_link || article.dndbeyond_link) && (
